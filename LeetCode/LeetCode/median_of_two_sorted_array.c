...
static double findMedianSortedArrays(int * num1, int sizenum1, int *num2, int sizenum2)
{
	int half = (sizenum1 + sizenum2) / 2;
	if ((sizenum1 + sizenum2) & 0x1) {
		return find_kth(num1, sizenum1, num2, sizenum2, half);
	}
	else {
		return (find_kth(num1, sizenum1, num2, sizenum2, half) + find_kth(num1, sizenum1, num2, sizenum2, half + 1)) / 2;
	}
}
